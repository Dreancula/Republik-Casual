...
class OrderController extends Controller
{
    ...
    public function selectShipping(Request $request)
    {
        ...
        $params = [
            ...
            'customer_details' => [
                ...
                'phone' => $customer->user->hp,
            ],
        ];

        $snapToken = Snap::getSnapToken($params);
        return view('v_order.select_shipping', compact('order', 'snapToken', 'totalHarga', 'totalBerat'));
    }
    ...
    public function selectPayment()
    {
        ...
        if (!$order) {
            return redirect()->route('order.cart')->with('error', 'Tidak ada pesanan yang perlu dibayar.');
        }
